...
<div style="text-align: center; width: 100%;">
    <div>
        <img src="./_docs/images/indexMenu.png" alt="indexMenu" style="width: 45%; margin: 10px;">
        <img src="./_docs/images/monsterBattle.png" alt="monsterBattle" style="width: 45%; margin: 10px;">
    </div>
    <div>
        <img src="./_docs/images/guitars.png" alt="guitars" style="width: 45%; margin: 10px;">
        <img src="./_docs/images/guitarModal.png" alt="guitarModal" style="width: 45%; margin: 10px;">
    </div>
    <div>
        <img src="./_docs/images/career.png" alt="career" style="width: 45%; margin: 10px;">
        <img src="./_docs/images/careerModal.png" alt="careerModal" style="width: 45%; margin: 10px;">
    </div>
    <div>
        <img src="./_docs/images/battleReport.png" alt="battleReport" style="width: 45%; margin: 10px;">
        <img src="" alt="architecture" style="width: 45%; margin: 10px;">
    </div>
</div>
