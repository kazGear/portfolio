...
func makersFactory() map[string]*Maker {
    ...
    makers[makerName] = NewMaker(
        makerName,
        scraper.NewScraperDean(),
        scraper.NewCallBacksDean(),
        scraper.NewCallBacksDean(),
    )
    ...
    makers[makerName] = NewMaker(
        makerName,
        scraper.NewScraperBCRich(),
        scraper.NewCallBacksBCRich(),
        scraper.NewCallBacksBCRich(),
    )

    makerName = "TOM ANDERSON"
    makers[makerName] = NewMaker(
        makerName,
        scraper.NewScraperTomAnderson(),
        scraper.NewCallBacksTomAnderson(),
        scraper.NewCallBacksTomAnderson(),
    )
    ...
    makers[makerName] = NewMaker(
        makerName,
        scraper.NewScraperKiller(),
        scraper.NewCallBacksKiller(),
        scraper.NewCallBacksKiller(),
    )
    ...
    makers[makerName] = NewMaker(
        makerName,
        scraper.NewScraperCaparison(),
        scraper.NewCallBacksCaparison(),
        scraper.NewCallBacksCaparison(),
    )
    ...
    makers[makerName] = NewMaker(
        makerName,
        scraper.NewScraperKiesel(),
        scraper.NewCallBacksKiesel(),
        scraper.NewCallBacksKiesel(),
    )
    ...
    makers[makerName] = NewMaker(
        makerName,
        scraper.NewScraperCharvel(),
        scraper.NewCallBacksCharvel(),
        scraper.NewCallBacksCharvel(),
    )
    ...
    makers[makerName] = NewMaker(
        makerName,
        scraper.NewScraperJackson(),
        scraper.NewCallBacksJackson(),
        scraper.NewCallBacksJackson(),
    )
