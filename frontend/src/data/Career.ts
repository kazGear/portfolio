...
export const portfolio: Portfolio = {
    ...
    "comment": [
        ...
        "<br/>",
        "◆ API・batch監視システム(異常時にプッシュ通知) ◆",
        "複数のバッチがバックグラウンドで実行されます。",
        "各バッチが正常に終了しなかった場合、それらのバッチについてエラーを通知します。",
...
export const prPoint: PrPoint[] = [
    {
        ...
        "comment":
            "機能追加や変更を見据えた責務分割を意識した設計を行っています。<br/>" +
            "過度な共通化を避け、可読性と変更容易性のバランスを考慮しながら、独立性の高いコンポーネント・API・処理単位へ分割することを重視しています。<br/>" +
